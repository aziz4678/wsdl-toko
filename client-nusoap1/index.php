	...
	<body>
		...
		<legend>Ubah Data</legend>
			<form name="form" method="POST" action="proses.php">
				...
				<label>ID Barang</label>
				<input type="text" value="<?=$_GET['id_barang']?>">
				<br/>
				<label>Nama Barang</label>
		...
		<?php } else { ?>
		<legend>Home</legend>
			Aplikasi sederhana ini menggunakan WSDL(Web Services Description Language) dengan format data XML(Extension Marakup Language). WSDL Server dan Client menggunakan library NuSoap.
		</fieldset>
		<?php } ?>
	</body>
	</html>